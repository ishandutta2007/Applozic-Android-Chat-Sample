...
/*  Todo: Will be used for device contacts
    ...
    public void setContactType(Integer contactType) {
        ...
        setApplozicType(this.contactType == ContactType.APPLOZIC.getValue() || this.contactType == ContactType.DEVICE_AND_APPLOZIC.getValue());
    }
    ...
    public boolean isDeviceContact(){
        return (contactType == ContactType.DEVICE.getValue());
    }


    public enum ContactType {
        APPLOZIC(0), DEVICE(1), DEVICE_AND_APPLOZIC(2);
