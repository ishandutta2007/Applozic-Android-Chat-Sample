...
public class MobiComDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_CONTACT_TABLE = " CREATE TABLE contact ( " +
            ...
            + CONTACT_TYPE + " integer default 0,"//add this column
            + APPLOZIC_TYPE +" integer default 1, "//add this column
            + STATUS +" varchar(2500) null, "
            + PHONE_CONTACT_DISPLAY_NAME +" varchar(100)," //add this column
    ...
    public int delDatabase() {
        ...
        db.execSQL("delete from " + CONTACT_TABLE_NAME + " where " + CONTACT_TYPE + " = 0");
